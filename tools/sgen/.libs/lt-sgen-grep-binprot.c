...
/* ./.libs/lt-sgen-grep-binprot.c - temporary wrapper executable for .libs/sgen-grep-binprot.exe
   Generated by libtool (GNU libtool) 2.4.6

   The sgen-grep-binprot program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "E:/mono2/eglib/src;";
const char * TARGET_PROGRAM_NAME = "sgen-grep-binprot.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sgen-grep-binprot - temporary wrapper script for .libs/sgen-grep-binprot.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The sgen-grep-binprot program cannot be directly executed until all the libto", f);
  fputs ("ol\n", f);
  ...
  fputs ("# script's /cygdrive/e/mono2/tools/sgen/../../libtool value, followed by yes.\n", f);
  ...
  fputs ("    echo \"sgen-grep-binprot.exe:sgen-grep-binprot:$LINENO: libtool wrapper (GNU", f);
  fputs (" libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"sgen-grep-binprot.exe:sgen-grep-binprot:$LINENO: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"sgen-grep-binprot.exe:sgen-grep-binprot:$LINENO: newargv[0]: $pr", f);
  fputs ("ogdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='sgen-grep-binprot.exe'\n", f);
  ...
  fputs ("    PATH=/cygdrive/e/mono2/eglib/src:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
