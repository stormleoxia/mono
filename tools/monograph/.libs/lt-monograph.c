...
/* ./.libs/lt-monograph.c - temporary wrapper executable for .libs/monograph.exe
   Generated by libtool (GNU libtool) 2.4.6

   The monograph program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "E:/mono2/mono/mini/.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "E:/mono2/eglib/src;E:/mono2/mono/mini/.libs;D:/Development/Tools/mono/lib;D:/Development/Tools/mono/bin;";
const char * TARGET_PROGRAM_NAME = "monograph.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# monograph - temporary wrapper script for .libs/monograph.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The monograph program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../../mono/mini/libmonosgen-2.0.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("# script's /cygdrive/e/mono2/tools/monograph/../../libtool value, followed by y", f);
  fputs ("es.\n", f);
  ...
  fputs ("    echo \"monograph.exe:monograph:$LINENO: libtool wrapper (GNU libtool) 2.4.6\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"monograph.exe:monograph:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"monograph.exe:monograph:$LINENO: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
  ...
  fputs ("    PATH=/cygdrive/e/mono2/eglib/src:/cygdrive/e/mono2/mono/mini/.libs:/cygdriv", f);
  fputs ("e/d/Development/Tools/mono/lib:/cygdrive/d/Development/Tools/mono/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/e/mono2/mono/mini/.libs:$PATH\"\n", f);
  fputs ("\n", f);
