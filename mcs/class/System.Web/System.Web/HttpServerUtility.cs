...
namespace System.Web
{
    ...
    public sealed class HttpServerUtility
    {
        ...
        internal static CultureInfo CreateReadOnlySpecificCultureInfo(string name)
        {
            ...
            var ci = CultureInfo.CreateSpecificCulture(name);
        ...
        public void Execute(string path, TextWriter writer, bool preserveForm)
        {
            ...
            var physPath = request.MapPath(virtualPath); // get physical path
            ...
            try
            {
                ...
                var useAppConfig = !filePath.IsWithinAppRoot;
        ...
        internal void Execute(IHttpHandler handler, TextWriter writer, bool preserveForm, bool setPreviousPage)
        {
            ...
            var physicalPath = request.MapPath(filePath);
            ...
            VirtualPath path, VirtualPath filePath, string physPath, Exception error, string queryStringOverride)
        {
            ...
            var request = _context.Request;
            var response = _context.Response;
            var app = _context.ApplicationInstance;
            ...
            try
            {
                try
                {
                    ...
                    var targetPage = handler as Page;
                    if (targetPage != null)
                    {
                        if (setPreviousPage)
                        {
                        ...
                        var sourcePage = _context.Handler as Page;
...
#pragma warning restore 0618
                    ...
                    else if (handler is IHttpAsyncHandler)
                    {
                        ...
                        try
                        {
                            ...
                            if (!AppSettings.UseTaskFriendlySynchronizationContext)
                            {
                                ...
                                var ar = asyncHandler.BeginProcessRequest(_context, null, null);

                                // wait for completion
                                if (!ar.IsCompleted)
                                {
                                    // suspend app lock while waiting
                                    var needToRelock = false;
            ...
            if (error != null)
            {
                ...
                throw new HttpException(
                    SR.GetString(SR.Error_executing_child_request_for_handler, handler.GetType().ToString()), error);
            }
        }
        ...
        {
            var page = _context.Handler as Page;
        ...
        {
            TransferRequest(path, false, null, null, true);
        }

        public void TransferRequest(string path, bool preserveForm)
        {
            TransferRequest(path, preserveForm, null, null, true);
        }

        public void TransferRequest(string path, bool preserveForm, string method, NameValueCollection headers)
        {
            TransferRequest(path, preserveForm, method, headers, true);
        }
        ...
        {
            var topPage = _context.Handler as Page;
            var childPage = handler as Page;
            ...
            ErrorFormatterGenerator errorFormatterGenerator)
        {
            ...
            var app = HttpApplicationFactory.GetApplicationInstance(context) as HttpApplication;
        ...
        private static readonly object _machineNameLock = new object();
        ...
        {
            var e = (_context != null) ? _context.Response.ContentEncoding : Encoding.UTF8;
        ...
        {
            var e = (_context != null) ? _context.Request.ContentEncoding : Encoding.UTF8;
    ...
    public sealed class HttpUtility
    {
        ...
        {
            var flags = NumberStyles.AllowLeadingWhite | NumberStyles.AllowTrailingWhite |
