...
namespace System.Web {
    ...
    public sealed class HttpRuntime {
        ...
        private static void StaticInit() {
            ...
            if (NotSupportedMethods.GetModuleHandle(ModName.ENGINE_FULL_NAME) != IntPtr.Zero) {
                isEngineLoaded = true;
            }
           ...
           if (!isEngineLoaded) {
                ...
                if (NotSupportedMethods.LoadLibrary(fullPath) != IntPtr.Zero) {
                    isEngineLoaded = true;
            ...
            if (isEngineLoaded) {
                NotSupportedMethods.InitializeLibrary(false);

                if (wasEngineLoadedHere) {
                    NotSupportedMethods.PerfCounterInitialize();
                }
            }
                ...
                try {
                    ...
                    if(compilationSection != null) {
                        ...
                        if(_enablePrefetchOptimization) {
                            NotSupportedMethods.StartPrefetchActivity((uint)StringUtil.GetStringHashCode(_appDomainAppId));
                        }
                    }
...
#pragma warning restore 618
        ...
        internal static String GetGacLocation() {
            ...
            if (AlternativeNativeMethods.GetCachePath(2, buf, ref iSize) >= 0)
                return buf.ToString();
