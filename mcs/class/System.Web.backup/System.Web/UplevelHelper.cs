    ...
    internal sealed class UplevelHelper {
        ...
        private static bool ScanForMatch_2_3(string ua, out bool hasJavaScript, int ualength) {
            ...
            for (int ualeft = ualength; (ualeft >= 8); ualeft = (ualeft - 1)) {
                if ((((ua[(startPosition + 0)] == ')') && (ua[(endPosition - 0)] == '/')) && (((ua[(startPosition + 1)] == ' ') && (ua[(endPosition - 1)] == 'o')) && (((ua[(startPosition + 2)] == 'G') && (ua[(endPosition - 2)] == 'k')) && ((ua[(startPosition + 4)] == 'c') && (ua[(endPosition - 4)] == 'e')))))) {
                    hasJavaScript = true;
                    return true;
                }
        ...
        private static bool ScanForMatch_2_4(string ua, out bool hasJavaScript, int ualength) {
            ...
            for (int ualeft = ualength; (ualeft >= 7); ualeft = (ualeft - 1)) {
                if ((((ua[(startPosition + 0)] == ')') && (ua[(endPosition - 0)] == 'a')) && (((ua[(startPosition + 1)] == ' ') && (ua[(endPosition - 1)] == 'r')) && (((ua[(startPosition + 2)] == 'O') && (ua[(endPosition - 2)] == 'e')) && (ua[(startPosition + 3)] == 'p'))))) {
                    hasJavaScript = true;
                    return true;
                }
                startPosition = (startPosition + 1);
        ...
        private static bool ScanForMatch_2_6(string ua, out bool hasJavaScript, int ualength) {
            ...
            for (int ualeft = ualength; (ualeft >= 6); ualeft = (ualeft - 1)) {
                if ((((ua[(startPosition + 0)] == '(') && (ua[(endPosition - 0)] == 'L')) && (((ua[(startPosition + 1)] == 'K') && (ua[(endPosition - 1)] == 'M')) && ((ua[(startPosition + 3)] == 'T') && (ua[(endPosition - 3)] == 'H'))))) {
                    hasJavaScript = true;
                    return true;
                }
                startPosition = (startPosition + 1);
