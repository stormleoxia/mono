...
namespace System.Web.Mobile
{
    ...
    internal class SR
    {
        ...
        internal const string RegularExpressionValidator_ValidationExpression =
            "RegularExpressionValidator_ValidationExpression";
        ...
        internal const string DataSourceHelper_DataSourceWithoutDataMember =
            "DataSourceHelper_DataSourceWithoutDataMember";

        internal const string DeviceSpecific_OnlyChoiceElementsAllowed = "DeviceSpecific_OnlyChoiceElementsAllowed";

        internal const string DeviceSpecificChoice_OverridingPropertyNotFound =
            "DeviceSpecificChoice_OverridingPropertyNotFound";

        internal const string DeviceSpecificChoice_OverridingPropertyTypeCast =
            "DeviceSpecificChoice_OverridingPropertyTypeCast";

        internal const string DeviceSpecificChoice_OverridingPropertyNotDeclarable =
            "DeviceSpecificChoice_OverridingPropertyNotDeclarable";

        internal const string DeviceSpecificChoice_InvalidPropertyOverride =
            "DeviceSpecificChoice_InvalidPropertyOverride";

        internal const string DeviceSpecificChoice_PropertyNotAnAttribute =
            "DeviceSpecificChoice_PropertyNotAnAttribute";

        internal const string DeviceSpecificChoice_ChoiceOnlyExistInDeviceSpecific =
            "DeviceSpecificChoice_ChoiceOnlyExistInDeviceSpecific";
        ...
        internal const string IndividualDeviceConfig_TypeMustSupportInterface =
            "IndividualDeviceConfig_TypeMustSupportInterface";

        internal const string IndividualDeviceConfig_ControlWithIncorrectPageAdapter =
            "IndividualDeviceConfig_ControlWithIncorrectPageAdapter";
        ...
        internal const string MobileControlBuilder_ControlMustBeTopLevelOfPage =
            "MobileControlBuilder_ControlMustBeTopLevelOfPage";

        internal const string MobileControlBuilder_StyleMustBeInStyleSheet =
            "MobileControlBuilder_StyleMustBeInStyleSheet";

        internal const string MobileControlsSectionHandler_UnknownElementName =
            "MobileControlsSectionHandler_UnknownElementName";

        internal const string MobileControlsSectionHandler_DeviceConfigNotFound =
            "MobileControlsSectionHandler_DeviceConfigNotFound";

        internal const string MobileControlsSectionHandler_CantCreateMethodOnClass =
            "MobileControlsSectionHandler_CantCreateMethodOnClass";

        internal const string MobileControlsSectionHandler_TypeNotFound = "MobileControlsSectionHandler_TypeNotFound";

        internal const string MobileControlsSectionHandler_DuplicatedDeviceName =
            "MobileControlsSectionHandler_DuplicatedDeviceName";

        internal const string MobileControlsSectionHandler_NotAssignable = "MobileControlsSectionHandler_NotAssignable";

        internal const string MobileControlsSectionHandler_CircularReference =
            "MobileControlsSectionHandler_CircularReference";
        ...
        internal const string MobileErrorInfo_CompilationErrorDescription =
            "MobileErrorInfo_CompilationErrorDescription";
        ...
        internal const string MobileListItemCollection_ViewStateManagementError =
            "MobileListItemCollection_ViewStateManagementError";
        ...
        internal const string MobileTypeNameConverter_UnsupportedValueType =
            "MobileTypeNameConverter_UnsupportedValueType";
        ...
        internal const string ObjectList_CannotSetViewModeWithNoSelectedItem =
            "ObjectList_CannotSetViewModeWithNoSelectedItem";

        internal const string ObjectList_MustBeInListModeToClearSelectedIndex =
            "ObjectList_MustBeInListModeToClearSelectedIndex";
        ...
        internal const string SessionViewState_InvalidSessionStateHistory =
            "SessionViewState_InvalidSessionStateHistory";

        internal const string SessionViewState_ExpiredOrCookieless = "SessionViewState_ExpiredOrCookieless";

        internal const string SelectionList_AdapterNotHandlingLoadPostData =
            "SelectionList_AdapterNotHandlingLoadPostData";
        ...
        internal const string AppliedDeviceFiltersDialog_AppliedDeviceFilters =
            "AppliedDeviceFiltersDialog_AppliedDeviceFilters";

        internal const string AppliedDeviceFiltersDialog_AssociatedItemsWillBeLost =
            "AppliedDeviceFiltersDialog_AssociatedItemsWillBeLost";

        internal const string AppliedDeviceFiltersDialog_ApplyDeviceFilter =
            "AppliedDeviceFiltersDialog_ApplyDeviceFilter";

        internal const string AppliedDeviceFiltersDialog_AvailableDeviceFilters =
        ...
        internal const string AppliedDeviceFiltersDialog_DuplicateChoices =
            "AppliedDeviceFiltersDialog_DuplicateChoices";

        internal const string AppliedDeviceFiltersDialog_DefaultFilterAlreadyApplied =
            "AppliedDeviceFiltersDialog_DefaultFilterAlreadyApplied";

        internal const string BaseTemplatedMobileComponentEditor_TemplateModeErrorMessage =
            "BaseTemplatedMobileComponentEditor_TemplateModeErrorMessage";

        internal const string BaseTemplatedMobileComponentEditor_TemplateModeErrorTitle =
        ...
        internal const string DeviceFilterEditorDialog_IllegalDefaultName =
        ...
        internal const string DeviceFilterEditorDialog_WebConfigMissingOnOpen =
        ...
        internal const string DeviceFilterEditorDialog_WebConfigParsingError =
        ...
        internal const string PropertyOverridesDialog_AppliedDeviceFilters =
        ...
        internal const string PropertyOverridesDialog_DeviceSpecificProperties =
            "PropertyOverridesDialog_DeviceSpecificProperties";

        internal const string PropertyOverridesDialog_InvalidPropertyValue =
        ...
        internal const string ListGeneralPage_SelectTypeMultiSelectListBox =
        ...
        internal const string MobileControl_FormPanelContainmentErrorMessage =
            "MobileControl_FormPanelContainmentErrorMessage";

        internal const string MobileControl_StrictlyFormPanelContainmentErrorMessage =
            "MobileControl_StrictlyFormPanelContainmentErrorMessage";

        internal const string MobileControl_TopPageContainmentErrorMessage =
        ...
        internal const string MobileControl_SettingGenericChoiceDescription =
            "MobileControl_SettingGenericChoiceDescription";

        internal const string MobileControl_DeviceSpecificPropsDescription =
            "MobileControl_DeviceSpecificPropsDescription";

        internal const string MobileControl_AppliedDeviceFiltersDescription =
            "MobileControl_AppliedDeviceFiltersDescription";

        internal const string MobileControl_InnerTextCannotContainTagsDesigner =
        ...
        internal const string MobileWebFormDesigner_NonMobileControlOnPageWarning =
            "MobileWebFormDesigner_NonMobileControlOnPageWarning";

        internal const string MobileWebFormDesigner_NonMobileControlCreatedWarning =
            "MobileWebFormDesigner_NonMobileControlCreatedWarning";
        ...
        internal const string ObjectListCommandsPage_DefaultCommandCaption =
            "ObjectListCommandsPage_DefaultCommandCaption";

        internal const string ObjectListCommandsPage_CommandListGroupLabel =
        ...
        internal const string ObjectListCommandsPage_NewCommandBtnCaption =
            "ObjectListCommandsPage_NewCommandBtnCaption";

        internal const string ObjectListCommandsPage_PropertiesGroupLabel =
            "ObjectListCommandsPage_PropertiesGroupLabel";
        ...
        internal const string ObjectListFieldsPage_AutoGenerateFieldsCaption =
        ...
        internal const string ObjectListFieldsPage_DataFormatStringCaption =
        ...
        internal const string ObjectListGeneralPage_BackCommandTextCaption =
            "ObjectListGeneralPage_BackCommandTextCaption";

        internal const string ObjectListGeneralPage_DetailsCommandTextCaption =
        ...
        internal const string ObjectListGeneralPage_PrivateDataSourceMessage =
            "ObjectListGeneralPage_PrivateDataSourceMessage";

        internal const string ObjectListGeneralPage_TableFieldsGroupLabel =
            "ObjectListGeneralPage_TableFieldsGroupLabel";

        internal const string ObjectListGeneralPage_TableFieldsAvailableListLabel =
            "ObjectListGeneralPage_TableFieldsAvailableListLabel";

        internal const string ObjectListGeneralPage_TableFieldsSelectedListLabel =
            "ObjectListGeneralPage_TableFieldsSelectedListLabel";
        ...
        internal const string StylesEditorDialog_StylePropertiesGroupLabel =
        ...
        internal const string StyleSheet_SettingTemplatingStyleChoiceDescription =
            "StyleSheet_SettingTemplatingStyleChoiceDescription";

        internal const string StyleSheet_SettingGenericStyleChoiceDescription =
        ...
        internal const string TemplateableDesigner_SetTemplatesFilterVerb =
            "TemplateableDesigner_SetTemplatesFilterVerb";

        internal const string TemplateableDesigner_SettingTemplatingChoiceDescription =
            "TemplateableDesigner_SettingTemplatingChoiceDescription";

        internal const string TemplateableDesigner_SettingGenericChoiceDescription =
            "TemplateableDesigner_SettingGenericChoiceDescription";

        internal const string TemplateableDesigner_TemplateChoiceDescription =
        ...
        internal const string TemplatingOptionsDialog_CHTMLSchemaFriendly =
