...
/* ./.libs/lt-mono-sgen.c - temporary wrapper executable for .libs/mono-sgen.exe
   Generated by libtool (GNU libtool) 2.4.6

   The mono-sgen program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "mono-sgen.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# mono-sgen - temporary wrapper script for .libs/mono-sgen.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The mono-sgen program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' libmonosgen-2.0.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"mono-sgen.exe:mono-sgen:$LINENO: libtool wrapper (GNU libtool) 2.4.6\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"mono-sgen.exe:mono-sgen:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"mono-sgen.exe:mono-sgen:$LINENO: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
