...
/* ./.libs/lt-mono-boehm.c - temporary wrapper executable for .libs/mono-boehm.exe
   Generated by libtool (GNU libtool) 2.4.6

   The mono-boehm program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "mono-boehm.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# mono-boehm - temporary wrapper script for .libs/mono-boehm.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The mono-boehm program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' libmonoboehm-2.0.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("# script's /cygdrive/e/mono2/mono/mini/../../libtool value, followed by yes.\n", f);
  ...
  fputs ("    echo \"mono-boehm.exe:mono-boehm:$LINENO: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"mono-boehm.exe:mono-boehm:$LINENO: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"mono-boehm.exe:mono-boehm:$LINENO: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
