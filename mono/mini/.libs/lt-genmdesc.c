...
/* ./.libs/lt-genmdesc.c - temporary wrapper executable for .libs/genmdesc.exe
   Generated by libtool (GNU libtool) 2.4.6

   The genmdesc program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "genmdesc.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# genmdesc - temporary wrapper script for .libs/genmdesc.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The genmdesc program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"genmdesc.exe:genmdesc:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"genmdesc.exe:genmdesc:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"genmdesc.exe:genmdesc:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
