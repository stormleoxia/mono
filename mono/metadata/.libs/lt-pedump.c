...
/* ./.libs/lt-pedump.c - temporary wrapper executable for .libs/pedump.exe
   Generated by libtool (GNU libtool) 2.4.6

   The pedump program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "pedump.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# pedump - temporary wrapper script for .libs/pedump.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The pedump program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("# script's /cygdrive/e/mono2/mono/metadata/../../libtool value, followed by yes", f);
  fputs (".\n", f);
  ...
  fputs ("    echo \"pedump.exe:pedump:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"pedump.exe:pedump:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"pedump.exe:pedump:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
