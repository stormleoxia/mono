...
/* ./.libs/lt-monodis.c - temporary wrapper executable for .libs/monodis.exe
   Generated by libtool (GNU libtool) 2.4.6

   The monodis program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "monodis.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# monodis - temporary wrapper script for .libs/monodis.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The monodis program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("# script's /cygdrive/e/mono2/mono/dis/../../libtool value, followed by yes.\n", f);
  ...
  fputs ("    echo \"monodis.exe:monodis:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"monodis.exe:monodis:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"monodis.exe:monodis:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
